...
def on_connect(client, userdata, flags, rc):
  ...
  client.subscribe("ece180d/test/anton1", qos=1)
...
def on_message(client, userdata, message): 
    ...
    client.publish('ece180d/test/anton2',str(int(message.payload) + 1), qos=1)
  # client.publish('ece180d/test1', 'From Anton: 4-way Communication Hello', qos=1)
